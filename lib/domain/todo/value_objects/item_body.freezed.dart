...
/// @nodoc
class _$ItemBodyValidationErrorTearOff {
  const _$ItemBodyValidationErrorTearOff();
...
/// @nodoc
const $ItemBodyValidationError = _$ItemBodyValidationErrorTearOff();

/// @nodoc
mixin _$ItemBodyValidationError {
  @optionalTypeArgs
...
/// @nodoc
abstract class $ItemBodyValidationErrorCopyWith<$Res> {
  factory $ItemBodyValidationErrorCopyWith(ItemBodyValidationError value,
          $Res Function(ItemBodyValidationError) then) =
      _$ItemBodyValidationErrorCopyWithImpl<$Res>;
}

/// @nodoc
class _$ItemBodyValidationErrorCopyWithImpl<$Res>
    implements $ItemBodyValidationErrorCopyWith<$Res> {
  _$ItemBodyValidationErrorCopyWithImpl(this._value, this._then);

  final ItemBodyValidationError _value;
  // ignore: unused_field
  final $Res Function(ItemBodyValidationError) _then;
}
...
class _$NullOrEmptyCopyWithImpl<$Res>
    extends _$ItemBodyValidationErrorCopyWithImpl<$Res>
...
class _$NullOrEmpty implements NullOrEmpty {
  ...
  @override
  String toString() {
    return 'ItemBodyValidationError.nullOrEmpty()';
  }
...
abstract class NullOrEmpty implements ItemBodyValidationError {
...
class _$TooLong implements TooLong {
  ...
  @override
  String toString() {
    return 'ItemBodyValidationError.tooLong(maxLength: $maxLength)';
  }
...
abstract class TooLong implements ItemBodyValidationError {
